...
// PACKAGES USED FOR AUTHENTICATION: npm install --save @nestjs/passport passport passport-local @nestjs/jwt passport-jwt npm install --save-dev @types/passport-local @types/passport-jwt
...
async function bootstrap() {
  ...
  .setDescription("Metadata about the application")
  .setVersion('1.0')
  .addBearerAuth()
  .build();
